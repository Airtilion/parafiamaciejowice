        ...
        <>
            ...
            <section className='my-[64px] w-[1240px] mx-auto max-xl:w-[1000px] max-lg:w-[90%] flex flex-col gap-[32px]'>
                ...
                <Link to="http://mogily.pl/maciejowice" rel="noopener noreferer" target='_blank'>
                    <button className='text-[18px] h-[50px] text-black px-[55px] bg-[#CDA272] rounded-[5px] cursor-pointer duration-700 hover:bg-[#947551] hover:text-white max-sm:text-[16px] max-sm:px-[40px]'>Kliknij aby przejść do strony cmentarza</button>
                </Link>
