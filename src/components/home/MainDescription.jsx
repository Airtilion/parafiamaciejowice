...
const MainDescription = () => {
  return (
    <section className='w-[1240px] flex justify-between items-center my-[128px] mx-auto gap-[128px] max-2xl:w-[1000px] max-xl:w-[900px] max-lg:flex-col max-lg:w-[80%] max-lg:gap-[64px]'>
