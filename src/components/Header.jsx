  ...
  return (
    <header className='text-[40px] max-sm:text-[10px]'>
      <section className='h-[778px] relative flex flex-col justify-center items-center gap-4'>
        ...
        <h1 className='text-[35px] w-[560px] z-10 text-white text-center font-light max-2xl:text-[30px] max-md:text-[25px] max-sm:w-[90%]'>Parafia pw. Wniebowzięcia NMP w Maciejowicach</h1>
